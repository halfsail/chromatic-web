    ...
    <div class="list_item_grid">
        <div class="icon">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M4.16561 10.8333C3.1904 10.8626 2.60897 10.971 2.20666 11.3733C1.80434 11.7756 1.69591 12.3571 1.66669 13.3323M6.66776 10.8333C7.64298 10.8626 8.2244 10.971 8.62672 11.3733C9.02903 11.7756 9.13746 12.3571 9.16669 13.3323M9.16669 15.8344C9.13746 16.8096 9.02903 17.3911 8.62672 17.7934C8.2244 18.1957 7.64298 18.3041 6.66776 18.3333M4.16562 18.3333C3.1904 18.3041 2.60897 18.1957 2.20666 17.7934C1.80434 17.3911 1.69591 16.8096 1.66669 15.8344" stroke="var(--copy-color)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
        ...
        <path d="M6 9.00049L11.2929 14.2934C11.6262 14.6267 11.7929 14.7934 12 14.7934C12.2071 14.7934 12.3738 14.6267 12.7071 14.2934L18 9.00049" stroke="var(--copy-color)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
...
<section>
    ...
    <div class="list_item haptics">
        <div class="icon">
            <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M20.1666 11H16.5L13.75 19.25L8.24998 2.75L5.49998 11H1.83331" stroke="var(--copy-color)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
        </div>
...
<style>
    .container, section {
      --copy-color: var(--text-color-primary);
        padding: 0 .5rem;
        display: flex;
...
.list_item_grid {
    ...
    .dropDown {
        ...
        &:hover {
            background-color: var(--surface-inset-hover);
            border-color: var(--surface-edge);
...
.material-toggle-slider {
  ...
  background-color: var(--surface-inset); /* Unchecked state color */
...
.material-toggle-input:checked + .material-toggle-slider {
  background-color: var(--accent); /* Checked state color (Material Blue) */
}
