...
var root_12 = add_locations(template(`<div class="sonner-loading-bar"></div>`), Loader[FILENAME], [[15, 3]]);
var root = add_locations(template(`<div><div class="sonner-spinner"></div></div>`), Loader[FILENAME], [[9, 0, [[13, 1]]]]);
function Loader($$anchor, $$props) {
  ...
  template_effect(
    ($0) => {
      set_class(div, clsx($0));
      set_attribute(div, "data-visible", $$props.visible);
    },
    [
      () => ["sonner-loading-wrapper", $$props.class].filter(Boolean).join(" ")
    ]
  );
  append($$anchor, div);
  return pop({ ...legacy_api() });
...
// node_modules/runed/dist/utilities/animation-frames/animation-frames.svelte.js
var _callback, _fpsLimitOption, _fpsLimit, _previousTimestamp, _frame, _fps, _running, _window, _AnimationFrames_instances, loop_fn;
var AnimationFrames = class {
  constructor(callback, options = {}) {
    __privateAdd(this, _AnimationFrames_instances);
    __privateAdd(this, _callback);
    __privateAdd(this, _fpsLimitOption, 0);
    __privateAdd(this, _fpsLimit, derived(() => extract(__privateGet(this, _fpsLimitOption)) ?? 0));
    ...
    __privateAdd(this, _window, defaultWindow);
    if (options.window) __privateSet(this, _window, options.window);
    __privateSet(this, _fpsLimitOption, options.fpsLimit);
  ...
  start() {
    ...
    __privateSet(this, _previousTimestamp, 0);
    __privateSet(this, _frame, __privateGet(this, _window).requestAnimationFrame(__privateMethod(this, _AnimationFrames_instances, loop_fn).bind(this)));
  }
  stop() {
    if (!__privateGet(this, _frame) || !__privateGet(this, _window)) return;
    set(__privateGet(this, _running), false);
    __privateGet(this, _window).cancelAnimationFrame(__privateGet(this, _frame));
...
_fpsLimitOption = new WeakMap();
_fpsLimit = new WeakMap();
...
loop_fn = function(timestamp) {
  if (!get(__privateGet(this, _running)) || !__privateGet(this, _window)) return;
  ...
  const fps = 1e3 / delta;
  if (get(__privateGet(this, _fpsLimit)) && fps > get(__privateGet(this, _fpsLimit))) {
    __privateSet(this, _frame, __privateGet(this, _window).requestAnimationFrame(__privateMethod(this, _AnimationFrames_instances, loop_fn).bind(this)));
    return;
  }
...
// node_modules/runed/dist/internal/utils/function.js
function noop2() {
}

// node_modules/runed/dist/utilities/use-resize-observer/use-resize-observer.svelte.js
...
// node_modules/runed/dist/utilities/is-focus-within/is-focus-within.svelte.js
var _node, _activeElement, _current;
var IsFocusWithin = class {
  constructor(node, options = {}) {
    __privateAdd(this, _node);
    __privateAdd(this, _activeElement);
    __privateAdd(this, _current, derived(() => {
      const node = extract(__privateGet(this, _node));
...
// node_modules/runed/dist/utilities/use-event-listener/use-event-listener.svelte.js
  ...
  user_effect(() => {
    ...
    if (Array.isArray(events)) {
      for (const event2 of events) {
        user_effect(() => on(target, event2, handler, options));
      }
    } else {
...
function runResource(source, fetcher, options = {}, effectFn) {
  ...
  const runCleanup = () => {
    ...
    set(cleanupFns, proxy([], null, cleanupFns));
  };
  const onCleanup = (fn) => {
    set(cleanupFns, proxy([...get(cleanupFns), fn], null, cleanupFns));
  };
  const baseFetcher = async (value, previousValue, refetching = false) => {
    try {
      ...
      set(current, proxy(result, null, current));
      return result;
    } catch (e) {
      if (!(e instanceof DOMException && strict_equals(e.name, "AbortError"))) {
        set(error, proxy(e, null, error));
      }
      return void 0;
    } finally {
      set(loading, false);
  ...
  return {
    ...
    mutate: (value) => {
      set(current, proxy(value, null, current));
    },
    refetch: (info) => {
...
// node_modules/runed/dist/utilities/state-history/state-history.svelte.js
...
// node_modules/runed/dist/utilities/textarea-autosize/textarea-autosize.svelte.js
var stylesToCopy = [
  "box-sizing",
  "width",
  "padding-top",
...
var _options, _resizeTimeout, _hiddenTextarea, _element, _input, _styleProp, _maxHeight, _textareaHeight, _textareaOldWidth, _TextareaAutosize_instances, createHiddenTextarea_fn, copyStyles_fn;
var TextareaAutosize = class {
  constructor(options) {
    __privateAdd(this, _TextareaAutosize_instances);
    __privateAdd(this, _options);
    __privateAdd(this, _resizeTimeout, null);
    __privateAdd(this, _hiddenTextarea, null);
    __privateAdd(this, _element, derived(() => extract(__privateGet(this, _options).element)));
    __privateAdd(this, _input, derived(() => extract(__privateGet(this, _options).input)));
    __privateAdd(this, _styleProp, derived(() => extract(__privateGet(this, _options).styleProp, "height")));
    __privateAdd(this, _maxHeight, derived(() => extract(__privateGet(this, _options).maxHeight, void 0)));
    __privateAdd(this, _textareaHeight, state(0));
    __privateAdd(this, _textareaOldWidth, state(0));
    /**
     ...
     */
    __publicField(this, "triggerResize", () => {
      if (!this.element || !__privateGet(this, _hiddenTextarea)) return;
      __privateMethod(this, _TextareaAutosize_instances, copyStyles_fn).call(this);
      __privateGet(this, _hiddenTextarea).value = this.input || "";
      const scrollHeight = __privateGet(this, _hiddenTextarea).scrollHeight;
    ...
    __privateMethod(this, _TextareaAutosize_instances, createHiddenTextarea_fn).call(this);
    watch([() => this.input, () => this.element], () => {
      tick().then(() => this.triggerResize());
    });
    watch(() => this.textareaHeight, () => {
      var _a;
      return (_a = options == null ? void 0 : options.onResize) == null ? void 0 : _a.call(options);
    });
    ...
    user_effect(() => {
      return () => {
        if (__privateGet(this, _hiddenTextarea)) {
          __privateGet(this, _hiddenTextarea).remove();
          __privateSet(this, _hiddenTextarea, null);
        }
        if (__privateGet(this, _resizeTimeout)) {
          window.cancelAnimationFrame(__privateGet(this, _resizeTimeout));
          __privateSet(this, _resizeTimeout, null);
        }
      };
    });
  }
  get element() {
    return get(__privateGet(this, _element));
  }
  set element(_) {
    throw new Error("Cannot update a derived property ('element')");
  }
  get input() {
    return get(__privateGet(this, _input));
  }
  set input(_) {
    throw new Error("Cannot update a derived property ('input')");
  }
  get styleProp() {
    return get(__privateGet(this, _styleProp));
  }
  set styleProp(_) {
    throw new Error("Cannot update a derived property ('styleProp')");
  }
  get maxHeight() {
    return get(__privateGet(this, _maxHeight));
  }
  set maxHeight(_) {
    throw new Error("Cannot update a derived property ('maxHeight')");
  }
  get textareaHeight() {
    return get(__privateGet(this, _textareaHeight));
  }
  set textareaHeight(value) {
    set(__privateGet(this, _textareaHeight), proxy(value, null, __privateGet(this, _textareaHeight)));
  }
  get textareaOldWidth() {
    return get(__privateGet(this, _textareaOldWidth));
  }
  set textareaOldWidth(value) {
    set(__privateGet(this, _textareaOldWidth), proxy(value, null, __privateGet(this, _textareaOldWidth)));
  }
  [ADD_OWNER](owner) {
    add_owner_to_class(this, owner, [
      () => get(__privateGet(this, _element)),
      () => get(__privateGet(this, _input)),
      () => get(__privateGet(this, _styleProp)),
      () => get(__privateGet(this, _maxHeight)),
      () => get(__privateGet(this, _textareaHeight)),
      () => get(__privateGet(this, _textareaOldWidth))
    ]);
  }
};
_options = new WeakMap();
_resizeTimeout = new WeakMap();
_hiddenTextarea = new WeakMap();
_element = new WeakMap();
_input = new WeakMap();
_styleProp = new WeakMap();
_maxHeight = new WeakMap();
_textareaHeight = new WeakMap();
_textareaOldWidth = new WeakMap();
_TextareaAutosize_instances = new WeakSet();
// Copy all the styles that affect text layout
createHiddenTextarea_fn = function() {
  if (strict_equals(typeof window, "undefined")) return;
  __privateSet(this, _hiddenTextarea, document.createElement("textarea"));
  const style = __privateGet(this, _hiddenTextarea).style;
  ...
  style.top = "0";
  style.left = "-9999px";
  document.body.appendChild(__privateGet(this, _hiddenTextarea));
};
copyStyles_fn = function() {
  if (!this.element || !__privateGet(this, _hiddenTextarea)) return;
  const computed = window.getComputedStyle(this.element);
  for (const style of stylesToCopy) {
    __privateGet(this, _hiddenTextarea).style.setProperty(style, computed.getPropertyValue(style));
  }
  __privateGet(this, _hiddenTextarea).style.width = `${this.element.clientWidth}px`;
};

// node_modules/runed/dist/utilities/scroll-state/scroll-state.svelte.js
var ARRIVED_STATE_THRESHOLD_PIXELS = 1;
var _options2, _element2, _idle, _offset, _onScroll, _onStop, _eventListenerOptions, _behavior, _onError, _internalX, _internalY, _x, _y, _isScrolling, _arrived, _directions, _onScrollHandler;
var ScrollState = class {
  constructor(options) {
    __privateAdd(this, _options2);
    __privateAdd(this, _element2, derived(() => extract(__privateGet(this, _options2).element)));
    __privateAdd(this, _idle, derived(() => {
      var _a;
      return extract((_a = __privateGet(this, _options2)) == null ? void 0 : _a.idle, 200);
    }));
    __privateAdd(this, _offset, derived(() => extract(__privateGet(this, _options2).offset, { left: 0, right: 0, top: 0, bottom: 0 })));
    __privateAdd(this, _onScroll, derived(() => __privateGet(this, _options2).onScroll ?? noop2));
    __privateAdd(this, _onStop, derived(() => __privateGet(this, _options2).onStop ?? noop2));
    __privateAdd(this, _eventListenerOptions, derived(() => __privateGet(this, _options2).eventListenerOptions ?? { capture: false, passive: true }));
    __privateAdd(this, _behavior, derived(() => extract(__privateGet(this, _options2).behavior, "auto")));
    __privateAdd(this, _onError, derived(() => __privateGet(this, _options2).onError ?? ((e) => {
      console.error(...log_if_contains_state("error", e));
    })));
    __privateAdd(this, _internalX, state(0));
    __privateAdd(this, _internalY, state(0));
    __privateAdd(this, _x, derived(() => this.internalX));
    __privateAdd(this, _y, derived(() => this.internalY));
    __privateAdd(this, _isScrolling, state(false));
    __privateAdd(this, _arrived, state(proxy({
      left: true,
      right: false,
      top: true,
      bottom: false
    })));
    __privateAdd(this, _directions, state(proxy({
      left: false,
      right: false,
      top: false,
      bottom: false
    ...
    __publicField(this, "setArrivedState", () => {
      ...
      const el = ((_b = (_a = this.element) == null ? void 0 : _a.document) == null ? void 0 : _b.documentElement) || ((_c = this.element) == null ? void 0 : _c.documentElement) || this.element;
  ...
  get element() {
    return get(__privateGet(this, _element2));
  }
  set element(_) {
    throw new Error("Cannot update a derived property ('element')");
  }
  get idle() {
    return get(__privateGet(this, _idle));
  }
  set idle(_) {
    throw new Error("Cannot update a derived property ('idle')");
  }
  get offset() {
    return get(__privateGet(this, _offset));
  }
  set offset(_) {
    throw new Error("Cannot update a derived property ('offset')");
  }
  get onScroll() {
    return get(__privateGet(this, _onScroll));
  }
  set onScroll(_) {
    throw new Error("Cannot update a derived property ('onScroll')");
  }
  get onStop() {
    return get(__privateGet(this, _onStop));
  }
  set onStop(_) {
    throw new Error("Cannot update a derived property ('onStop')");
  }
  get eventListenerOptions() {
    return get(__privateGet(this, _eventListenerOptions));
  }
  set eventListenerOptions(_) {
    throw new Error("Cannot update a derived property ('eventListenerOptions')");
  }
  get behavior() {
    return get(__privateGet(this, _behavior));
  }
  set behavior(_) {
    throw new Error("Cannot update a derived property ('behavior')");
  }
  get onError() {
    return get(__privateGet(this, _onError));
  }
  set onError(_) {
    throw new Error("Cannot update a derived property ('onError')");
  }
  get internalX() {
    return get(__privateGet(this, _internalX));
  }
  set internalX(value) {
    set(__privateGet(this, _internalX), proxy(value, null, __privateGet(this, _internalX)));
  }
  get internalY() {
    return get(__privateGet(this, _internalY));
  }
  set internalY(value) {
    set(__privateGet(this, _internalY), proxy(value, null, __privateGet(this, _internalY)));
  }
  get x() {
    return get(__privateGet(this, _x));
  }
  set x(v) {
    this.scrollTo(v, void 0);
  }
  get y() {
    return get(__privateGet(this, _y));
  }
  set y(v) {
    this.scrollTo(void 0, v);
  }
  get isScrolling() {
    return get(__privateGet(this, _isScrolling));
  }
  set isScrolling(value) {
    set(__privateGet(this, _isScrolling), proxy(value, null, __privateGet(this, _isScrolling)));
  }
  get arrived() {
    return get(__privateGet(this, _arrived));
  }
  set arrived(value) {
    set(__privateGet(this, _arrived), proxy(value, null, __privateGet(this, _arrived)));
  }
  get directions() {
    return get(__privateGet(this, _directions));
  }
  set directions(value) {
    set(__privateGet(this, _directions), proxy(value, null, __privateGet(this, _directions)));
  }
  /**
  ...
  scrollTo(x, y) {
    var _a, _b, _c, _d;
    if (!window) return;
    (_a = this.element instanceof Document ? window.document.body : this.element) == null ? void 0 : _a.scrollTo({
      top: y ?? this.y,
      left: x ?? this.x,
      behavior: this.behavior
    });
    const scrollContainer = ((_c = (_b = this.element) == null ? void 0 : _b.document) == null ? void 0 : _c.documentElement) || ((_d = this.element) == null ? void 0 : _d.documentElement) || this.element;
  ...
  scrollToBottom() {
    var _a, _b, _c;
    if (!window) return;
    const scrollContainer = ((_b = (_a = this.element) == null ? void 0 : _a.document) == null ? void 0 : _b.documentElement) || ((_c = this.element) == null ? void 0 : _c.documentElement) || this.element;
    if (!scrollContainer) return;
    this.scrollTo(void 0, scrollContainer.scrollHeight);
  }
  [ADD_OWNER](owner) {
    add_owner_to_class(this, owner, [
      () => get(__privateGet(this, _element2)),
      () => get(__privateGet(this, _idle)),
      () => get(__privateGet(this, _offset)),
      () => get(__privateGet(this, _onScroll)),
      () => get(__privateGet(this, _onStop)),
      () => get(__privateGet(this, _eventListenerOptions)),
      () => get(__privateGet(this, _behavior)),
      () => get(__privateGet(this, _onError)),
      () => get(__privateGet(this, _internalX)),
      () => get(__privateGet(this, _internalY)),
      () => get(__privateGet(this, _isScrolling)),
      () => get(__privateGet(this, _arrived)),
      () => get(__privateGet(this, _directions))
    ]);
  }
};
...
_onStop = new WeakMap();
_eventListenerOptions = new WeakMap();
_behavior = new WeakMap();
_onError = new WeakMap();
_internalX = new WeakMap();
_internalY = new WeakMap();
_x = new WeakMap();
_y = new WeakMap();
_isScrolling = new WeakMap();
_arrived = new WeakMap();
_directions = new WeakMap();
_onScrollHandler = new WeakMap();
...
var ToastState = class {
  ...
  set toasts(value) {
    set(__privateGet(this, _toasts), proxy(value, null, __privateGet(this, _toasts)));
  }
  get heights() {
    return get(__privateGet(this, _heights));
  }
  set heights(value) {
    set(__privateGet(this, _heights), proxy(value, null, __privateGet(this, _heights)));
  }
  [ADD_OWNER](owner) {
    add_owner_to_class(this, owner, [
      () => get(__privateGet(this, _toasts)),
      () => get(__privateGet(this, _heights))
    ]);
  }
};
_toasts = new WeakMap();
...
var SonnerState = class {
  constructor() {
    __privateAdd(this, _activeToasts, derived(() => toastState.toasts.filter((toast2) => !toast2.dismiss)));
  }
  get toasts() {
...
function useDocumentHidden() {
  ...
  user_effect(() => {
    return on(document, "visibilitychange", () => {
      set(current, proxy(document.hidden, null, current));
    });
  });
  return {
    get current() {
...
var root_2 = add_locations(template(`<div><!></div>`), Toast[FILENAME], [[316, 2]]);
...
var root_4 = add_locations(template(`<button data-close-button=""><!></button>`), Toast[FILENAME], [[373, 2]]);
var root_72 = add_locations(template(`<div data-icon=""><!> <!></div>`), Toast[FILENAME], [[393, 3]]);
var root_24 = add_locations(template(`<div data-description=""><!></div>`), Toast[FILENAME], [[431, 4]]);
...
var root_30 = add_locations(template(`<button data-button="" data-cancel=""> </button>`), Toast[FILENAME], [[453, 4]]);
...
var root_34 = add_locations(template(`<button data-button=""> </button>`), Toast[FILENAME], [[476, 4]]);
var root_6 = add_locations(template(`<!> <div data-content=""><div data-title=""><!></div> <!></div> <!> <!>`, 1), Toast[FILENAME], [[416, 2, [[417, 3]]]]);
var root2 = add_locations(template(`<li data-sonner-toast=""><!> <!></li>`), Toast[FILENAME], [[331, 0]]);
function Toast($$anchor, $$props) {
  check_target(new.target);
  push($$props, true, Toast);
  const LoadingIcon = wrap_snippet(Toast, ($$anchor2) => {
    var fragment = comment();
    var node = first_child(fragment);
    {
      var consequent = ($$anchor3) => {
        ...
        template_effect(
          ...
          [
            () => {
              var _a, _b, _c;
              return cn((_a = get(classes)) == null ? void 0 : _a.loader, (_c = (_b = $$props.toast) == null ? void 0 : _b.classes) == null ? void 0 : _c.loader, "sonner-loader");
            }
          ]
        );
        append($$anchor3, div);
      ...
      var alternate = ($$anchor3) => {
        ...
        const expression_1 = derived(() => strict_equals(get(toastType), "loading"));
  ...
  const isFront = derived(() => strict_equals($$props.index, 0));
  const isVisible = derived(() => $$props.index + 1 <= $$props.visibleToasts);
  const toastType = derived(() => $$props.toast.type);
  const dismissable = derived(() => strict_equals($$props.toast.dismissable, false, false));
  const toastClass = derived(() => $$props.toast.class || "");
  const toastDescriptionClass = derived(() => $$props.toast.descriptionClass || "");
  const heightIndex = derived(() => toastState.heights.findIndex((height) => strict_equals(height.toastId, $$props.toast.id)) || 0);
  ...
  const disabled = derived(() => strict_equals(get(toastType), "loading"));
  ...
  user_effect(() => {
    ...
    set(initialHeight, proxy(finalHeight, null, initialHeight));
  ...
  function deleteToast() {
    set(removed, true);
    set(offsetBeforeRemove, proxy(get(offset), null, offsetBeforeRemove));
  ...
  let timeoutId;
  const isPromiseLoadingOrInfiniteDuration = derived(() => $$props.toast.promise && strict_equals(get(toastType), "loading") || strict_equals($$props.toast.duration, Number.POSITIVE_INFINITY));
  function startTimer() {
    set(closeTimerStartTime, proxy((/* @__PURE__ */ new Date()).getTime(), null, closeTimerStartTime));
    timeoutId = setTimeout(
      () => {
        var _a, _b;
  ...
  function pauseTimer() {
    ...
    set(lastCloseTimerStartTime, proxy((/* @__PURE__ */ new Date()).getTime(), null, lastCloseTimerStartTime));
  }
  user_effect(() => {
  ...
  onMount(() => {
    ...
    set(initialHeight, proxy(height, null, initialHeight));
  ...
  const handlePointerUp = () => {
    ...
    if (Math.abs(swipeAmount) >= SWIPE_THRESHOLD || velocity > 0.11) {
      ...
      if (strict_equals(get(swipeDirection), "x")) {
        set(swipeOutDirection, proxy(swipeAmountX > 0 ? "right" : "left", null, swipeOutDirection));
      } else {
        set(swipeOutDirection, proxy(swipeAmountY > 0 ? "down" : "up", null, swipeOutDirection));
      }
      deleteToast();
      set(swipeOut, true);
      return;
  ...
  const handlePointerMove = (event2) => {
    ...
    if (!get(swipeDirection) && (Math.abs(xDelta) > 1 || Math.abs(yDelta) > 1)) {
      set(swipeDirection, proxy(Math.abs(xDelta) > Math.abs(yDelta) ? "x" : "y", null, swipeDirection));
    }
    ...
    var consequent_1 = ($$anchor2) => {
      ...
      template_effect(
        ($0) => {
          ...
          set_class(button, clsx($0));
        },
        [
          () => {
            var _a, _b, _c;
            return cn((_a = get(classes)) == null ? void 0 : _a.closeButton, (_c = (_b = $$props.toast) == null ? void 0 : _b.classes) == null ? void 0 : _c.closeButton);
          }
        ]
      );
    ...
    var alternate_10 = ($$anchor2) => {
      ...
      var node_7 = first_child(fragment_3);
      {
        var consequent_11 = ($$anchor3) => {
                ...
                var alternate_5 = ($$anchor5) => {
                  ...
                  var node_14 = first_child(fragment_9);
                  {
                    var consequent_6 = ($$anchor6) => {
                      ...
                      snippet(node_15, () => $$props.successIcon ?? noop);
                    ...
                    var alternate_4 = ($$anchor6) => {
                      ...
                      var node_16 = first_child(fragment_11);
                      {
                        var consequent_7 = ($$anchor7) => {
                          ...
                          snippet(node_17, () => $$props.errorIcon ?? noop);
                        ...
                        var alternate_3 = ($$anchor7) => {
                          ...
                          var node_18 = first_child(fragment_13);
                          {
                            var consequent_8 = ($$anchor8) => {
                              ...
                              snippet(node_19, () => $$props.warningIcon ?? noop);
                            ...
                            var alternate_2 = ($$anchor8) => {
                              ...
                              var node_20 = first_child(fragment_15);
                              {
                                var consequent_9 = ($$anchor9) => {
                                  ...
                                  snippet(node_21, () => $$props.infoIcon ?? noop);
          ...
          reset(div_1);
          template_effect(($0) => set_class(div_1, clsx($0)), [
            () => {
              var _a, _b, _c;
              return cn((_a = get(classes)) == null ? void 0 : _a.icon, (_c = (_b = $$props.toast) == null ? void 0 : _b.classes) == null ? void 0 : _c.icon);
            }
          ]);
        ...
        var consequent_13 = ($$anchor3) => {
          ...
          var node_23 = first_child(fragment_17);
          {
            var consequent_12 = ($$anchor4) => {
              ...
              component(node_24, () => get(Title), ($$anchor5, $$component) => {
        ...
        var consequent_15 = ($$anchor3) => {
          ...
          var node_26 = child(div_4);
          {
            var consequent_14 = ($$anchor4) => {
              ...
              component(node_27, () => get(Description), ($$anchor5, $$component) => {
                $$component($$anchor5, spread_props(() => $$props.toast.componentProps));
              });
          ...
          reset(div_4);
          template_effect(($0) => set_class(div_4, clsx($0)), [
            () => {
              var _a, _b;
              return cn(descriptionClass(), get(toastDescriptionClass), (_a = get(classes)) == null ? void 0 : _a.description, (_b = $$props.toast.classes) == null ? void 0 : _b.description);
            }
          ]);
        ...
        var consequent_18 = ($$anchor3) => {
          ...
          var node_29 = first_child(fragment_22);
          {
            var consequent_16 = ($$anchor4) => {
              ...
              component(node_30, () => $$props.toast.cancel, ($$anchor5, $$component) => {
                $$component($$anchor5, {});
              });
            ...
            var alternate_8 = ($$anchor4) => {
              ...
              var node_31 = first_child(fragment_24);
              {
                var consequent_17 = ($$anchor5) => {
                  ...
                  template_effect(
                    ($0) => {
                      set_attribute(button_1, "style", $$props.toast.cancelButtonStyle ?? cancelButtonStyle());
                      set_class(button_1, clsx($0));
                      set_text(text_2, $$props.toast.cancel.label);
                    },
                    [
                      () => {
                        var _a, _b, _c;
                        return cn((_a = get(classes)) == null ? void 0 : _a.cancelButton, (_c = (_b = $$props.toast) == null ? void 0 : _b.classes) == null ? void 0 : _c.cancelButton);
                      }
                    ]
                  );
        ...
        var consequent_21 = ($$anchor3) => {
          ...
          var node_33 = first_child(fragment_25);
          {
            var consequent_19 = ($$anchor4) => {
              ...
              component(node_34, () => $$props.toast.action, ($$anchor5, $$component) => {
                $$component($$anchor5, {});
              });
            ...
            var alternate_9 = ($$anchor4) => {
              ...
              var node_35 = first_child(fragment_27);
              {
                var consequent_20 = ($$anchor5) => {
                  ...
                  template_effect(
                    ($0) => {
                      set_attribute(button_2, "style", $$props.toast.actionButtonStyle ?? actionButtonStyle());
                      set_class(button_2, clsx($0));
                      set_text(text_3, $$props.toast.action.label);
                    },
                    [
                      () => {
                        var _a, _b, _c;
                        return cn((_a = get(classes)) == null ? void 0 : _a.actionButton, (_c = (_b = $$props.toast) == null ? void 0 : _b.classes) == null ? void 0 : _c.actionButton);
                      }
                    ]
                  );
      ...
      template_effect(($0) => set_class(div_3, clsx($0)), [
        () => {
          var _a, _b, _c;
          return cn((_a = get(classes)) == null ? void 0 : _a.title, (_c = (_b = $$props.toast) == null ? void 0 : _b.classes) == null ? void 0 : _c.title);
        }
      ]);
  ...
  template_effect(
    ($0, $1, $2) => {
      ...
      set_attribute(li, "style", `${$$props.style} ${$$props.toast.style}`);
      set_style(li, "--index", $$props.index);
      set_style(li, "--toasts-before", $$props.index);
      set_style(li, "--z-index", toastState.toasts.length - $$props.index);
      set_style(li, "--offset", `${get(removed) ? get(offsetBeforeRemove) : get(offset)}px`);
      set_style(li, "--initial-height", $$props.expandByDefault ? "auto" : `${get(initialHeight)}px`);
    },
    [
      () => {
        var _a, _b, _c, _d, _e, _f;
        return cn($$props.class, get(toastClass), (_a = get(classes)) == null ? void 0 : _a.toast, (_c = (_b = $$props.toast) == null ? void 0 : _b.classes) == null ? void 0 : _c.toast, (_d = get(classes)) == null ? void 0 : _d[get(toastType)], (_f = (_e = $$props.toast) == null ? void 0 : _e.classes) == null ? void 0 : _f[get(toastType)]);
      },
...
var root3 = add_locations(ns_template(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" height="20" width="20" data-sonner-success-icon=""><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.857-9.809a.75.75 0 00-1.214-.882l-3.483 4.79-1.88-1.88a.75.75 0 10-1.06 1.061l2.5 2.5a.75.75 0 001.137-.089l4-5.5z" clip-rule="evenodd"></path></svg>`), SuccessIcon[FILENAME], [[1, 0, [[9, 1]]]]);
...
var root4 = add_locations(ns_template(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" height="20" width="20" data-sonner-error-icon=""><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-8-5a.75.75 0 01.75.75v4.5a.75.75 0 01-1.5 0v-4.5A.75.75 0 0110 5zm0 10a1 1 0 100-2 1 1 0 000 2z" clip-rule="evenodd"></path></svg>`), ErrorIcon[FILENAME], [[1, 0, [[9, 1]]]]);
...
var root5 = add_locations(ns_template(`<svg viewBox="0 0 64 64" fill="currentColor" height="20" width="20" data-sonner-warning-icon="" xmlns="http://www.w3.org/2000/svg"><path d="M32.427,7.987c2.183,0.124 4,1.165 5.096,3.281l17.936,36.208c1.739,3.66 -0.954,8.585 -5.373,8.656l-36.119,0c-4.022,-0.064 -7.322,-4.631 -5.352,-8.696l18.271,-36.207c0.342,-0.65 0.498,-0.838 0.793,-1.179c1.186,-1.375 2.483,-2.111 4.748,-2.063Zm-0.295,3.997c-0.687,0.034 -1.316,0.419 -1.659,1.017c-6.312,11.979 -12.397,24.081 -18.301,36.267c-0.546,1.225 0.391,2.797 1.762,2.863c12.06,0.195 24.125,0.195 36.185,0c1.325,-0.064 2.321,-1.584 1.769,-2.85c-5.793,-12.184 -11.765,-24.286 -17.966,-36.267c-0.366,-0.651 -0.903,-1.042 -1.79,-1.03Z"></path><path d="M33.631,40.581l-3.348,0l-0.368,-16.449l4.1,0l-0.384,16.449Zm-3.828,5.03c0,-0.609 0.197,-1.113 0.592,-1.514c0.396,-0.4 0.935,-0.601 1.618,-0.601c0.684,0 1.223,0.201 1.618,0.601c0.395,0.401 0.593,0.905 0.593,1.514c0,0.587 -0.193,1.078 -0.577,1.473c-0.385,0.395 -0.929,0.593 -1.634,0.593c-0.705,0 -1.249,-0.198 -1.634,-0.593c-0.384,-0.395 -0.576,-0.886 -0.576,-1.473Z"></path></svg>`), WarningIcon[FILENAME], [[1, 0, [[9, 1], [12, 1]]]]);
...
var root6 = add_locations(ns_template(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" height="20" width="20" data-sonner-info-icon=""><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a.75.75 0 000 1.5h.253a.25.25 0 01.244.304l-.459 2.066A1.75 1.75 0 0010.747 15H11a.75.75 0 000-1.5h-.253a.25.25 0 01-.244-.304l.459-2.066A1.75 1.75 0 009.253 9H9z" clip-rule="evenodd"></path></svg>`), InfoIcon[FILENAME], [[1, 0, [[9, 1]]]]);
...
var root_22 = add_locations(template(`<ol></ol>`), Toaster[FILENAME], [[250, 3]]);
var root8 = add_locations(template(`<section aria-live="polite" aria-relevant="additions text" aria-atomic="false" class="s-KjATBeAaNTDC"><!></section>`), Toaster[FILENAME], [[237, 0]]);
var $$css = {
  hash: "s-KjATBeAaNTDC",
  code: "\n	html[dir='ltr'],\n	[data-sonner-toaster][dir='ltr'] {\n		--toast-icon-margin-start: -3px;\n		--toast-icon-margin-end: 4px;\n		--toast-svg-margin-start: -1px;\n		--toast-svg-margin-end: 0px;\n		--toast-button-margin-start: auto;\n		--toast-button-margin-end: 0;\n		--toast-close-button-start: 0;\n		--toast-close-button-end: unset;\n		--toast-close-button-transform: translate(-35%, -35%);\n	}\n\n	html[dir='rtl'],\n	[data-sonner-toaster][dir='rtl'] {\n		--toast-icon-margin-start: 4px;\n		--toast-icon-margin-end: -3px;\n		--toast-svg-margin-start: 0px;\n		--toast-svg-margin-end: -1px;\n		--toast-button-margin-start: 0;\n		--toast-button-margin-end: auto;\n		--toast-close-button-start: unset;\n		--toast-close-button-end: 0;\n		--toast-close-button-transform: translate(35%, -35%);\n	}\n\n	[data-sonner-toaster] {\n		position: fixed;\n		width: var(--width);\n		font-family:\n			ui-sans-serif,\n			system-ui,\n			-apple-system,\n			BlinkMacSystemFont,\n			Segoe UI,\n			Roboto,\n			Helvetica Neue,\n			Arial,\n			Noto Sans,\n			sans-serif,\n			Apple Color Emoji,\n			Segoe UI Emoji,\n			Segoe UI Symbol,\n			Noto Color Emoji;\n		--gray1: hsl(0, 0%, 99%);\n		--gray2: hsl(0, 0%, 97.3%);\n		--gray3: hsl(0, 0%, 95.1%);\n		--gray4: hsl(0, 0%, 93%);\n		--gray5: hsl(0, 0%, 90.9%);\n		--gray6: hsl(0, 0%, 88.7%);\n		--gray7: hsl(0, 0%, 85.8%);\n		--gray8: hsl(0, 0%, 78%);\n		--gray9: hsl(0, 0%, 56.1%);\n		--gray10: hsl(0, 0%, 52.3%);\n		--gray11: hsl(0, 0%, 43.5%);\n		--gray12: hsl(0, 0%, 9%);\n		--border-radius: 8px;\n		box-sizing: border-box;\n		padding: 0;\n		margin: 0;\n		list-style: none;\n		outline: none;\n		z-index: 999999999;\n		transition: transform 400ms ease;\n	}\n\n	@media (hover: none) and (pointer: coarse) {\n		[data-sonner-toaster][data-lifted='true'] {\n			transform: none;\n		}\n	}\n\n	[data-sonner-toaster][data-x-position='right'] {\n		right: var(--offset-right);\n	}\n\n	[data-sonner-toaster][data-x-position='left'] {\n		left: var(--offset-left);\n	}\n\n	[data-sonner-toaster][data-x-position='center'] {\n		left: 50%;\n		transform: translateX(-50%);\n	}\n\n	[data-sonner-toaster][data-y-position='top'] {\n		top: var(--offset-top);\n	}\n\n	[data-sonner-toaster][data-y-position='bottom'] {\n		bottom: var(--offset-bottom);\n	}\n\n	[data-sonner-toast] {\n		--y: translateY(100%);\n		--lift-amount: calc(var(--lift) * var(--gap));\n		z-index: var(--z-index);\n		position: absolute;\n		opacity: 0;\n		transform: var(--y);\n		touch-action: none;\n		transition:\n			transform 400ms,\n			opacity 400ms,\n			height 400ms,\n			box-shadow 200ms;\n		box-sizing: border-box;\n		outline: none;\n		overflow-wrap: anywhere;\n	}\n\n	[data-sonner-toast][data-styled='true'] {\n		padding: 16px;\n		background: var(--normal-bg);\n		border: 1px solid var(--normal-border);\n		color: var(--normal-text);\n		border-radius: var(--border-radius);\n		box-shadow: 0px 4px 12px rgba(0, 0, 0, 0.1);\n		width: var(--width);\n		font-size: 13px;\n		display: flex;\n		align-items: center;\n		gap: 6px;\n	}\n\n	[data-sonner-toast]:focus-visible {\n		box-shadow:\n			0px 4px 12px rgba(0, 0, 0, 0.1),\n			0 0 0 2px rgba(0, 0, 0, 0.2);\n	}\n\n	[data-sonner-toast][data-y-position='top'] {\n		top: 0;\n		--y: translateY(-100%);\n		--lift: 1;\n		--lift-amount: calc(1 * var(--gap));\n	}\n\n	[data-sonner-toast][data-y-position='bottom'] {\n		bottom: 0;\n		--y: translateY(100%);\n		--lift: -1;\n		--lift-amount: calc(var(--lift) * var(--gap));\n	}\n\n	[data-sonner-toast][data-styled='true'] [data-description] {\n		font-weight: 400;\n		line-height: 1.4;\n		color: #3f3f3f;\n	}\n\n	[data-rich-colors='true'][data-sonner-toast][data-styled='true']\n		[data-description] {\n		color: inherit;\n	}\n\n	[data-sonner-toaster][data-sonner-theme='dark'] [data-description] {\n		color: hsl(0, 0%, 91%);\n	}\n\n	[data-sonner-toast][data-styled='true'] [data-title] {\n		font-weight: 500;\n		line-height: 1.5;\n		color: inherit;\n	}\n\n	[data-sonner-toast][data-styled='true'] [data-icon] {\n		display: flex;\n		height: 16px;\n		width: 16px;\n		position: relative;\n		justify-content: flex-start;\n		align-items: center;\n		flex-shrink: 0;\n		margin-left: var(--toast-icon-margin-start);\n		margin-right: var(--toast-icon-margin-end);\n	}\n\n	[data-sonner-toast][data-promise='true'] [data-icon] > svg {\n		opacity: 0;\n		transform: scale(0.8);\n		transform-origin: center;\n		animation: sonner-fade-in 300ms ease forwards;\n	}\n\n	[data-sonner-toast][data-styled='true'] [data-icon] > * {\n		flex-shrink: 0;\n	}\n\n	[data-sonner-toast][data-styled='true'] [data-icon] svg {\n		margin-left: var(--toast-svg-margin-start);\n		margin-right: var(--toast-svg-margin-end);\n	}\n\n	[data-sonner-toast][data-styled='true'] [data-content] {\n		display: flex;\n		flex-direction: column;\n		gap: 2px;\n	}\n\n	[data-sonner-toast][data-styled='true'] [data-button] {\n		border-radius: 4px;\n		padding-left: 8px;\n		padding-right: 8px;\n		height: 24px;\n		font-size: 12px;\n		color: var(--normal-bg);\n		background: var(--normal-text);\n		margin-left: var(--toast-button-margin-start);\n		margin-right: var(--toast-button-margin-end);\n		border: none;\n		font-weight: 500;\n		cursor: pointer;\n		outline: none;\n		display: flex;\n		align-items: center;\n		flex-shrink: 0;\n		transition:\n			opacity 400ms,\n			box-shadow 200ms;\n	}\n\n	[data-sonner-toast][data-styled='true'] [data-button]:focus-visible {\n		box-shadow: 0 0 0 2px rgba(0, 0, 0, 0.4);\n	}\n\n	[data-sonner-toast][data-styled='true'] [data-button]:first-of-type {\n		margin-left: var(--toast-button-margin-start);\n		margin-right: var(--toast-button-margin-end);\n	}\n\n	[data-sonner-toast][data-styled='true'] [data-cancel] {\n		color: var(--normal-text);\n		background: rgba(0, 0, 0, 0.08);\n	}\n\n	[data-sonner-toaster][data-sonner-theme='dark']\n		[data-sonner-toast][data-styled='true']\n		[data-cancel] {\n		background: rgba(255, 255, 255, 0.3);\n	}\n\n	[data-sonner-toast][data-styled='true'] [data-close-button] {\n		position: absolute;\n		left: var(--toast-close-button-start);\n		right: var(--toast-close-button-end);\n		top: 0;\n		height: 20px;\n		width: 20px;\n		display: flex;\n		justify-content: center;\n		align-items: center;\n		padding: 0;\n		color: var(--gray12);\n		background: var(--normal-bg);\n		border: 1px solid var(--gray4);\n		transform: var(--toast-close-button-transform);\n		border-radius: 50%;\n		cursor: pointer;\n		z-index: 1;\n		transition:\n			opacity 100ms,\n			background 200ms,\n			border-color 200ms;\n	}\n\n	[data-sonner-toast][data-styled='true'] [data-close-button]:focus-visible {\n		box-shadow:\n			0px 4px 12px rgba(0, 0, 0, 0.1),\n			0 0 0 2px rgba(0, 0, 0, 0.2);\n	}\n\n	[data-sonner-toast][data-styled='true'] [data-disabled='true'] {\n		cursor: not-allowed;\n	}\n\n	[data-sonner-toast][data-styled='true']:hover [data-close-button]:hover {\n		background: var(--gray2);\n		border-color: var(--gray5);\n	}\n\n	[data-sonner-toast][data-swiping='true']::before {\n		content: '';\n		position: absolute;\n		left: -100%;\n		right: -100%;\n		height: 100%;\n		z-index: -1;\n	}\n\n	[data-sonner-toast][data-y-position='top'][data-swiping='true']::before {\n		bottom: 50%;\n		transform: scaleY(3) translateY(50%);\n	}\n\n	[data-sonner-toast][data-y-position='bottom'][data-swiping='true']::before {\n		top: 50%;\n		transform: scaleY(3) translateY(-50%);\n	}\n\n	[data-sonner-toast][data-swiping='false'][data-removed='true']::before {\n		content: '';\n		position: absolute;\n		inset: 0;\n		transform: scaleY(2);\n	}\n\n	[data-sonner-toast][data-expanded='true']::after {\n		content: '';\n		position: absolute;\n		left: 0;\n		height: calc(var(--gap) + 1px);\n		bottom: 100%;\n		width: 100%;\n	}\n\n	[data-sonner-toast][data-mounted='true'] {\n		--y: translateY(0);\n		opacity: 1;\n	}\n\n	[data-sonner-toast][data-expanded='false'][data-front='false'] {\n		--scale: var(--toasts-before) * 0.05 + 1;\n		--y: translateY(calc(var(--lift-amount) * var(--toasts-before)))\n			scale(calc(-1 * var(--scale)));\n		height: var(--front-toast-height);\n	}\n\n	[data-sonner-toast] > * {\n		transition: opacity 400ms;\n	}\n\n	[data-sonner-toast][data-x-position='right'] {\n		right: 0;\n	}\n\n	[data-sonner-toast][data-x-position='left'] {\n		left: 0;\n	}\n\n	[data-sonner-toast][data-expanded='false'][data-front='false'][data-styled='true']\n		> * {\n		opacity: 0;\n	}\n\n	[data-sonner-toast][data-visible='false'] {\n		opacity: 0;\n		pointer-events: none;\n	}\n\n	[data-sonner-toast][data-mounted='true'][data-expanded='true'] {\n		--y: translateY(calc(var(--lift) * var(--offset)));\n		height: var(--initial-height);\n	}\n\n	[data-sonner-toast][data-removed='true'][data-front='true'][data-swipe-out='false'] {\n		--y: translateY(calc(var(--lift) * -100%));\n		opacity: 0;\n	}\n\n	[data-sonner-toast][data-removed='true'][data-front='false'][data-swipe-out='false'][data-expanded='true'] {\n		--y: translateY(\n			calc(var(--lift) * var(--offset) + var(--lift) * -100%)\n		);\n		opacity: 0;\n	}\n\n	[data-sonner-toast][data-removed='true'][data-front='false'][data-swipe-out='false'][data-expanded='false'] {\n		--y: translateY(40%);\n		opacity: 0;\n		transition:\n			transform 500ms,\n			opacity 200ms;\n	}\n\n	[data-sonner-toast][data-removed='true'][data-front='false']::before {\n		height: calc(var(--initial-height) + 20%);\n	}\n\n	[data-sonner-toast][data-swiping='true'] {\n		transform: var(--y) translateY(var(--swipe-amount-y, 0px))\n			translateX(var(--swipe-amount-x, 0px));\n		transition: none;\n	}\n\n	[data-sonner-toast][data-swiped='true'] {\n		user-select: none;\n	}\n\n	[data-sonner-toast][data-swipe-out='true'][data-y-position='bottom'],\n	[data-sonner-toast][data-swipe-out='true'][data-y-position='top'] {\n		animation-duration: 200ms;\n		animation-timing-function: ease-out;\n		animation-fill-mode: forwards;\n	}\n\n	[data-sonner-toast][data-swipe-out='true'][data-swipe-direction='left'] {\n		animation-name: swipe-out-left;\n	}\n\n	[data-sonner-toast][data-swipe-out='true'][data-swipe-direction='right'] {\n		animation-name: swipe-out-right;\n	}\n\n	[data-sonner-toast][data-swipe-out='true'][data-swipe-direction='up'] {\n		animation-name: swipe-out-up;\n	}\n\n	[data-sonner-toast][data-swipe-out='true'][data-swipe-direction='down'] {\n		animation-name: swipe-out-down;\n	}\n\n	@keyframes swipe-out-left {\n		from {\n			transform: var(--y) translateX(var(--swipe-amount-x));\n			opacity: 1;\n		}\n\n		to {\n			transform: var(--y) translateX(calc(var(--swipe-amount-x) - 100%));\n			opacity: 0;\n		}\n	}\n\n	@keyframes swipe-out-right {\n		from {\n			transform: var(--y) translateX(var(--swipe-amount-x));\n			opacity: 1;\n		}\n\n		to {\n			transform: var(--y) translateX(calc(var(--swipe-amount-x) + 100%));\n			opacity: 0;\n		}\n	}\n\n	@keyframes swipe-out-up {\n		from {\n			transform: var(--y) translateY(var(--swipe-amount-y));\n			opacity: 1;\n		}\n\n		to {\n			transform: var(--y) translateY(calc(var(--swipe-amount-y) - 100%));\n			opacity: 0;\n		}\n	}\n\n	@keyframes swipe-out-down {\n		from {\n			transform: var(--y) translateY(var(--swipe-amount-y));\n			opacity: 1;\n		}\n\n		to {\n			transform: var(--y) translateY(calc(var(--swipe-amount-y) + 100%));\n			opacity: 0;\n		}\n	}\n\n	@media (max-width: 600px) {\n		[data-sonner-toaster] {\n			position: fixed;\n			right: var(--mobile-offset-right);\n			left: var(--mobile-offset-left);\n			width: 100%;\n		}\n\n		[data-sonner-toaster][dir='rtl'] {\n			left: calc(var(--mobile-offset-left) * -1);\n		}\n\n		[data-sonner-toaster] [data-sonner-toast] {\n			left: 0;\n			right: 0;\n			width: calc(100% - var(--mobile-offset-left) * 2);\n		}\n\n		[data-sonner-toaster][data-x-position='left'] {\n			left: var(--mobile-offset-left);\n		}\n\n		[data-sonner-toaster][data-y-position='bottom'] {\n			bottom: var(--mobile-offset-bottom);\n		}\n\n		[data-sonner-toaster][data-y-position='top'] {\n			top: var(--mobile-offset-top);\n		}\n\n		[data-sonner-toaster][data-x-position='center'] {\n			left: var(--mobile-offset-left);\n			right: var(--mobile-offset-right);\n			transform: none;\n		}\n	}\n\n	[data-sonner-toaster][data-sonner-theme='light'] {\n		--normal-bg: #fff;\n		--normal-border: var(--gray4);\n		--normal-text: var(--gray12);\n\n		--success-bg: hsl(143, 85%, 96%);\n		--success-border: hsl(145, 92%, 87%);\n		--success-text: hsl(140, 100%, 27%);\n\n		--info-bg: hsl(208, 100%, 97%);\n		--info-border: hsl(221, 91%, 93%);\n		--info-text: hsl(210, 92%, 45%);\n\n		--warning-bg: hsl(49, 100%, 97%);\n		--warning-border: hsl(49, 91%, 84%);\n		--warning-text: hsl(31, 92%, 45%);\n\n		--error-bg: hsl(359, 100%, 97%);\n		--error-border: hsl(359, 100%, 94%);\n		--error-text: hsl(360, 100%, 45%);\n	}\n\n	[data-sonner-toaster][data-sonner-theme='light']\n		[data-sonner-toast][data-invert='true'] {\n		--normal-bg: #000;\n		--normal-border: hsl(0, 0%, 20%);\n		--normal-text: var(--gray1);\n	}\n\n	[data-sonner-toaster][data-sonner-theme='dark']\n		[data-sonner-toast][data-invert='true'] {\n		--normal-bg: #fff;\n		--normal-border: var(--gray3);\n		--normal-text: var(--gray12);\n	}\n\n	[data-sonner-toaster][data-sonner-theme='dark'] {\n		--normal-bg: #000;\n		--normal-bg-hover: hsl(0, 0%, 12%);\n		--normal-border: hsl(0, 0%, 20%);\n		--normal-border-hover: hsl(0, 0%, 25%);\n		--normal-text: var(--gray1);\n\n		--success-bg: hsl(150, 100%, 6%);\n		--success-border: hsl(147, 100%, 12%);\n		--success-text: hsl(150, 86%, 65%);\n\n		--info-bg: hsl(215, 100%, 6%);\n		--info-border: hsl(223, 43%, 17%);\n		--info-text: hsl(216, 87%, 65%);\n\n		--warning-bg: hsl(64, 100%, 6%);\n		--warning-border: hsl(60, 100%, 9%);\n		--warning-text: hsl(46, 87%, 65%);\n\n		--error-bg: hsl(358, 76%, 10%);\n		--error-border: hsl(357, 89%, 16%);\n		--error-text: hsl(358, 100%, 81%);\n	}\n\n	[data-sonner-toaster][data-sonner-theme='dark']\n		[data-sonner-toast]\n		[data-close-button] {\n		background: var(--normal-bg);\n		border-color: var(--normal-border);\n		color: var(--normal-text);\n	}\n\n	[data-sonner-toaster][data-sonner-theme='dark']\n		[data-sonner-toast]\n		[data-close-button]:hover {\n		background: var(--normal-bg-hover);\n		border-color: var(--normal-border-hover);\n	}\n\n	[data-rich-colors='true'][data-sonner-toast][data-type='success'] {\n		background: var(--success-bg);\n		border-color: var(--success-border);\n		color: var(--success-text);\n	}\n\n	[data-rich-colors='true'][data-sonner-toast][data-type='success']\n		[data-close-button] {\n		background: var(--success-bg);\n		border-color: var(--success-border);\n		color: var(--success-text);\n	}\n\n	[data-rich-colors='true'][data-sonner-toast][data-type='info'] {\n		background: var(--info-bg);\n		border-color: var(--info-border);\n		color: var(--info-text);\n	}\n\n	[data-rich-colors='true'][data-sonner-toast][data-type='info']\n		[data-close-button] {\n		background: var(--info-bg);\n		border-color: var(--info-border);\n		color: var(--info-text);\n	}\n\n	[data-rich-colors='true'][data-sonner-toast][data-type='warning'] {\n		background: var(--warning-bg);\n		border-color: var(--warning-border);\n		color: var(--warning-text);\n	}\n\n	[data-rich-colors='true'][data-sonner-toast][data-type='warning']\n		[data-close-button] {\n		background: var(--warning-bg);\n		border-color: var(--warning-border);\n		color: var(--warning-text);\n	}\n\n	[data-rich-colors='true'][data-sonner-toast][data-type='error'] {\n		background: var(--error-bg);\n		border-color: var(--error-border);\n		color: var(--error-text);\n	}\n\n	[data-rich-colors='true'][data-sonner-toast][data-type='error']\n		[data-close-button] {\n		background: var(--error-bg);\n		border-color: var(--error-border);\n		color: var(--error-text);\n	}\n\n	.sonner-loading-wrapper {\n		--size: 16px;\n		height: var(--size);\n		width: var(--size);\n		position: absolute;\n		inset: 0;\n		z-index: 10;\n	}\n\n	.sonner-loading-wrapper[data-visible='false'] {\n		transform-origin: center;\n		animation: sonner-fade-out 0.2s ease forwards;\n	}\n\n	.sonner-spinner {\n		position: relative;\n		top: 50%;\n		left: 50%;\n		height: var(--size);\n		width: var(--size);\n	}\n\n	.sonner-loading-bar {\n		animation: sonner-spin 1.2s linear infinite;\n		background: var(--gray11);\n		border-radius: 6px;\n		height: 8%;\n		left: -10%;\n		position: absolute;\n		top: -3.9%;\n		width: 24%;\n	}\n\n	.sonner-loading-bar:nth-child(1) {\n		animation-delay: -1.2s;\n		transform: rotate(0.0001deg) translate(146%);\n	}\n\n	.sonner-loading-bar:nth-child(2) {\n		animation-delay: -1.1s;\n		transform: rotate(30deg) translate(146%);\n	}\n\n	.sonner-loading-bar:nth-child(3) {\n		animation-delay: -1s;\n		transform: rotate(60deg) translate(146%);\n	}\n\n	.sonner-loading-bar:nth-child(4) {\n		animation-delay: -0.9s;\n		transform: rotate(90deg) translate(146%);\n	}\n\n	.sonner-loading-bar:nth-child(5) {\n		animation-delay: -0.8s;\n		transform: rotate(120deg) translate(146%);\n	}\n\n	.sonner-loading-bar:nth-child(6) {\n		animation-delay: -0.7s;\n		transform: rotate(150deg) translate(146%);\n	}\n\n	.sonner-loading-bar:nth-child(7) {\n		animation-delay: -0.6s;\n		transform: rotate(180deg) translate(146%);\n	}\n\n	.sonner-loading-bar:nth-child(8) {\n		animation-delay: -0.5s;\n		transform: rotate(210deg) translate(146%);\n	}\n\n	.sonner-loading-bar:nth-child(9) {\n		animation-delay: -0.4s;\n		transform: rotate(240deg) translate(146%);\n	}\n\n	.sonner-loading-bar:nth-child(10) {\n		animation-delay: -0.3s;\n		transform: rotate(270deg) translate(146%);\n	}\n\n	.sonner-loading-bar:nth-child(11) {\n		animation-delay: -0.2s;\n		transform: rotate(300deg) translate(146%);\n	}\n\n	.sonner-loading-bar:nth-child(12) {\n		animation-delay: -0.1s;\n		transform: rotate(330deg) translate(146%);\n	}\n\n	@keyframes sonner-fade-in {\n		0% {\n			opacity: 0;\n			transform: scale(0.8);\n		}\n		100% {\n			opacity: 1;\n			transform: scale(1);\n		}\n	}\n\n	@keyframes sonner-fade-out {\n		0% {\n			opacity: 1;\n			transform: scale(1);\n		}\n		100% {\n			opacity: 0;\n			transform: scale(0.8);\n		}\n	}\n\n	@keyframes sonner-spin {\n		0% {\n			opacity: 1;\n		}\n		100% {\n			opacity: 0.15;\n		}\n	}\n\n	@media (prefers-reduced-motion) {\n		[data-sonner-toast],\n		[data-sonner-toast] > *,\n		.sonner-loading-bar {\n			transition: none !important;\n			animation: none !important;\n		}\n	}\n\n	.sonner-loader {\n		position: absolute;\n		top: 50%;\n		left: 50%;\n		transform: translate(-50%, -50%);\n		transform-origin: center;\n		transition:\n			opacity 200ms,\n			transform 200ms;\n	}\n\n	.sonner-loader[data-visible='false'] {\n		opacity: 0;\n		transform: scale(0.8) translate(-50%, -50%);\n	}\n\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"
};
function Toaster($$anchor, $$props) {
  ...
  user_effect(() => {
    ...
    if (strict_equals(typeof window, "undefined", false)) {
      ...
      const changeHandler = ({ matches }) => {
        set(actualTheme, proxy(matches ? DARK : LIGHT, null, actualTheme));
      };
  ...
  const handleBlur = (event2) => {
    var _a;
    (_a = $$props.onblur) == null ? void 0 : _a.call($$props, event2);
  ...
  const handleFocus = (event2) => {
    var _a;
    (_a = $$props.onfocus) == null ? void 0 : _a.call($$props, event2);
    ...
    if (!get(isFocusWithin)) {
      ...
      set(lastFocusedElementRef, proxy(event2.relatedTarget, null, lastFocusedElementRef));
    }
  };
  const handlePointerDown = (event2) => {
    var _a;
    (_a = $$props.onpointerdown) == null ? void 0 : _a.call($$props, event2);
    const isNotDismissable = event2.target instanceof HTMLElement && strict_equals(event2.target.dataset.dismissable, "false");
    if (isNotDismissable) return;
  ...
  const handleMouseEnter = (event2) => {
    var _a;
    (_a = $$props.onmouseenter) == null ? void 0 : _a.call($$props, event2);
    set(expanded, true);
  };
  const handleMouseLeave = (event2) => {
    var _a;
    (_a = $$props.onmouseleave) == null ? void 0 : _a.call($$props, event2);
    if (!get(interacting)) {
      set(expanded, false);
    }
  };
  const handleMouseMove = (event2) => {
    var _a;
    (_a = $$props.onmousemove) == null ? void 0 : _a.call($$props, event2);
    set(expanded, true);
  };
  const handleDragEnd = (event2) => {
    var _a;
    (_a = $$props.ondragend) == null ? void 0 : _a.call($$props, event2);
    set(expanded, false);
  };
  const handlePointerUp = (event2) => {
    var _a;
    (_a = $$props.onpointerup) == null ? void 0 : _a.call($$props, event2);
    ...
    var consequent_10 = ($$anchor2) => {
      ...
      each(node_1, 18, () => get(possiblePositions), (position2) => position2, ($$anchor3, position2, index, $$array) => {
        ...
        each(ol, 23, () => toastState.toasts.filter((toast2) => !toast2.position && strict_equals(get(index), 0) || strict_equals(toast2.position, position2)), (toast2) => toast2.id, ($$anchor4, toast2, index2, $$array_1) => {
          ...
          const expression_4 = derived(() => toastOptions().classes || {});
          const expression_5 = derived(() => toastOptions().unstyled ?? false);
          const expression_6 = derived(() => {
            var _a;
          ...
          });
          {
            ...
            const errorIcon = wrap_snippet(Toaster, ($$anchor5) => {
              ...
              var node_7 = first_child(fragment_6);
              {
                var consequent_2 = ($$anchor6) => {
                  ...
                  snippet(node_8, () => $$props.errorIcon ?? noop);
            ...
            const warningIcon = wrap_snippet(Toaster, ($$anchor5) => {
              var fragment_10 = comment();
              var node_11 = first_child(fragment_10);
              {
                var consequent_4 = ($$anchor6) => {
                  ...
                  snippet(node_12, () => $$props.warningIcon ?? noop);
                  append($$anchor6, fragment_11);
                };
            ...
            const infoIcon = wrap_snippet(Toaster, ($$anchor5) => {
              var fragment_14 = comment();
            ...
            const closeIcon = wrap_snippet(Toaster, ($$anchor5) => {
              var fragment_18 = comment();
              var node_19 = first_child(fragment_18);
              {
                var consequent_8 = ($$anchor6) => {
                  ...
                  snippet(node_20, () => $$props.closeIcon ?? noop);
        ...
        template_effect(
          ($0) => {
            ...
            set_style(ol, "--front-toast-height", `${(_a = toastState.heights[0]) == null ? void 0 : _a.height}px`);
            set_style(ol, "--width", `${TOAST_WIDTH}px`);
            set_style(ol, "--gap", `${gap()}px`);
            set_style(ol, "--offset-top", get(offsetObject)["--offset-top"]);
            set_style(ol, "--offset-right", get(offsetObject)["--offset-right"]);
            set_style(ol, "--offset-bottom", get(offsetObject)["--offset-bottom"]);
            set_style(ol, "--offset-left", get(offsetObject)["--offset-left"]);
            set_style(ol, "--mobile-offset-top", get(offsetObject)["--mobile-offset-top"]);
            set_style(ol, "--mobile-offset-right", get(offsetObject)["--mobile-offset-right"]);
            set_style(ol, "--mobile-offset-bottom", get(offsetObject)["--mobile-offset-bottom"]);
            set_style(ol, "--mobile-offset-left", get(offsetObject)["--mobile-offset-left"]);
            ol.dir = ol.dir;
          },
